...
### **1. Basit Hesaplama Kısmı:** 
Kullanıcıdan input() ile iki tane sayı (0 veya 1) ve bir de kapı ismi istiyorum.
...
### **2. Doğruluk Tablosu Kısmı :** 
Burada kullanıcıdan `A and (B or C)` gibi sözel bir ifade girmesi bekleniyor.
